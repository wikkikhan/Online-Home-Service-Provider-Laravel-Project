@include('admin/header')
      ...
      <div class="container rounded mt-5 p-5 mb-5 bg-light" style="border: 1px solid rgb(211, 210, 210);">
        <div class="row pb-3">
          <h1 style="font-weight: 500;">Employees Requests:</h1>
        </div>
        <div class="row">
                     ...
                     <table class="table  table-striped  table-hover">
                        <thead>
                            <tr class="d-flex text-white" style="font-weight: 900;">
                                ...
                                <th class="col-2 text-center">Verify</th>
                        ...
                        <td class="col-2 text-center">{{$emp->serviceTitle}}</td>
                            ...
                            <td class="col-2 text-center"><a href={{"verify/$emp->id"}}><button class="btn btn-primary rounded">Verify</button> </a></td>
                            <td class="col-2 text-center"><a href={{"Delete/$emp->id"}}> <button class="btn btn-primary rounded">Delete</button> </a></td>
                        </tr>
                        @endforeach
